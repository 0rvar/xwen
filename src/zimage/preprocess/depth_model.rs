// Adapted from Hugging Face Candle rev 21cca0b, MIT/Apache-2.0.
// Resize follows Depth-Anything-V2 author bilinear align_corners=true.
//! Depth Anything V2 Small depth head.
//!
//! See:
//! - ["Depth Anything: Unleashing the Power of Large-Scale Unlabeled Data"](https://github.com/DepthAnything/Depth-Anything-V2)
//!
...
use super::dino::DinoVisionTransformer;
...
impl Module for FeatureFusionBlock {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        ...
        let out = super::bilinear_tensor(&out, self.target_patch_size, self.target_patch_size)?;
...
impl Module for DPTHead {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        ...
        let out = super::bilinear_tensor(&out, self.input_image_size, self.input_image_size)?;
